...
def main():
    ...
    try:
        ...
        required_args.add_argument('--Symbols',
                                   '-S',
                                   type=str,
                                   nargs='+',
        ...
        required_args.add_argument('--Start_Date',
                                   '-s',
                                   metavar='-s',
                                   type=str,
        ...
        required_args.add_argument('--End_Date',
                                   '-e',
                                   type=str,
        ...
        required_args.add_argument('--Price_Actions',
                                   '-p',
                                   type=str,
                                   nargs='+',
        ...
        for stock_main in args.Symbols:
            ...
            [classes.graph.Graph.plot(data_main.date, getattr(data_main, price_action)) for price_action
             in args.Price_Actions]
